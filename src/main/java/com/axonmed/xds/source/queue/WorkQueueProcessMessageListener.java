package com.axonmed.xds.source.queue;
...
import com.axonmed.xds.source.service.WorkQueueStudyProcessService;
...
public class WorkQueueProcessMessageListener implements MessageListener {
	...
	@Autowired
	private WorkQueueStudyProcessService workQueueStudyProcessService;
